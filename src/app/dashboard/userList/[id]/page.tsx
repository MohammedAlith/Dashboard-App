  ...
  <p className="font-medium">
    ...
    <div className=" w-full max-w-lg">
      ...
      <table className="border-3 border-gray-300 w-full">
        <tbody>
          <tr>
            <td className="border-3 border-gray-300 p-2 font-medium">Department</td>
            <td className="border-3 border-gray-300 p-2">{user?.company.department}</td>
          </tr>
          <tr>
            <td className="border-3 border-gray-300 p-2 font-medium">Company Name</td>
            <td className="border-3 border-gray-300 p-2">{user?.company.name}</td>
          </tr>
          <tr>
            <td className="border-3 border-gray-300 p-2 font-medium">Title</td>
            <td className="border-3 border-gray-300 p-2">{user?.company.title}</td>
          </tr>
          <tr>
            <td className="border-3 border-gray-300 p-2 font-medium">Company Address</td>
